...
public class InfoHudViewHolder {
    ...
    public InfoHudViewHolder(Context context, TextView bsTextView) {
        this.bsTextView = bsTextView;
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    ...
                    bsTextView.setText(String.format(Locale.US, "%s", formatedSpeed(tcpSpeed, 1000)));
                }
            }
        }
    };
